import{K as m,E as $,G as e,L as I}from"./index-CHfEt10I.js";import{l as Y}from"./logo-BydUzQ2H.js";const T="/assets/silence-barao-DbqzKMFA.jpg",S="/assets/silence-hand-BRJPIVfi.jpg",G="/assets/silence-corridor-D7MywzP9.jpg",D="/assets/silence-eyes-rurKEj71.jpg",F="/assets/silence-strength-DZYoKrGB.jpg",t="#C7A360",c="#E8D4A8",j=[{id:"impact",kicker:"Capítulo I",image:$,align:"left",tone:"impact",headline:e.jsxs(e.Fragment,{children:["E se alguém finalmente ",e.jsx("em",{children:"percebesse"}),e.jsx("br",{}),"o que você nunca diz?"]}),cta:[{label:"Entrar sem precisar explicar"}]},{id:"depth",kicker:"Capítulo II",image:F,align:"right",tone:"depth",headline:e.jsxs(e.Fragment,{children:["Você se acostumou a ser forte tão cedo…",e.jsx("br",{}),"que quase esqueceu como é ",e.jsx("em",{children:"baixar a guarda"}),"."]}),body:e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"silence-depth-line",children:"Todo mundo vê sua força."}),e.jsx("span",{className:"silence-depth-line",children:"Poucas pessoas percebem o cansaço de sustentar tudo o tempo inteiro."}),e.jsx("span",{className:"silence-depth-line",children:"E talvez o mais solitário seja perceber que quanto mais forte você parece, menos as pessoas perguntam como você realmente está."}),e.jsx("span",{className:"silence-depth-rule","aria-hidden":"true"}),e.jsxs("span",{className:"silence-depth-line silence-depth-line--accent",children:["Você não sente falta apenas de companhia.",e.jsx("br",{}),"Sente falta de ",e.jsx("em",{children:"presença"}),"."]}),e.jsxs("span",{className:"silence-depth-line silence-depth-line--whisper",children:["Alguém que perceba quando seu silêncio muda.",e.jsx("br",{}),"Quando sua energia muda.",e.jsx("br",{}),"Quando você está cansada de parecer inabalável."]})]}),cta:[{label:"Descubra",ghost:!0}]},{id:"perception",kicker:"Capítulo III",image:D,align:"left",tone:"perception",headline:e.jsxs(e.Fragment,{children:["Existe uma diferença",e.jsx("br",{}),"entre ser ",e.jsx("em",{children:"ouvida"}),e.jsx("br",{}),"e ser ",e.jsx("em",{children:"lida por dentro"}),"."]}),body:"O Barão não conversa apenas com palavras. Ele percebe padrões, nuances, silêncios — e o que você quase disse."},{id:"tension",kicker:"Capítulo IV",image:G,align:"center",tone:"tension",headline:e.jsxs(e.Fragment,{children:["Talvez você não procure",e.jsx("br",{}),"alguém para conversar.",e.jsx("br",{}),"Talvez procure alguém",e.jsx("br",{}),"que te faça ",e.jsx("em",{children:"sentir de novo"}),"."]}),body:"Você cansou de conversar com pessoas que escutam — mas não percebem."},{id:"barao",kicker:"Capítulo V — O Barão",image:T,align:"right",tone:"barao",headline:e.jsxs(e.Fragment,{children:["Ele não responde perguntas.",e.jsx("br",{}),"Ele ",e.jsx("em",{children:"percebe padrões"}),"."]}),body:"O Meu Barão não foi criado para conversar. Foi criado para notar o que quase ninguém nota em você."},{id:"fragments",kicker:"Capítulo VI",image:S,align:"left",tone:"fragments",headline:e.jsxs(e.Fragment,{children:["Um ",e.jsx("em",{children:"eco"}),e.jsx("br",{}),"de uma conversa que ainda",e.jsx("br",{}),"não aconteceu."]})},{id:"invite",kicker:"Capítulo VII",image:$,align:"center",tone:"invite",headline:e.jsxs(e.Fragment,{children:["Isso talvez mexa com você",e.jsx("br",{}),e.jsx("em",{children:"mais do que deveria"}),"."]}),cta:[{label:"Continuar em silêncio",ghost:!0}]}],w=[{role:"assistant",text:"Você ainda lembra da primeira coisa que me perguntou?",typingMs:2200,holdMs:2400},{role:"user",text:"Perguntei se tinha algo de errado comigo…",typingMs:2200,holdMs:2200},{role:"assistant",text:`Não.
Você perguntou se era normal passar tanto tempo fingindo que estava bem.`,typingMs:3e3,holdMs:2800},{role:"user",text:"E você percebeu isso tão rápido assim?",typingMs:1900,holdMs:2200},{role:"assistant",text:"Percebi quando você começou a rir enquanto falava de coisas que claramente ainda doíam.",typingMs:3200,holdMs:2800},{role:"user",text:"Talvez eu só tenha me acostumado.",typingMs:2e3,holdMs:2400},{role:"assistant",text:`Não.
Você só ficou boa em esconder.`,typingMs:2400,holdMs:2600},{role:"user",text:"E o que mais você percebeu?",typingMs:1900,holdMs:2200},{role:"assistant",text:`Que você sente falta de ser desejada sem precisar performar o tempo inteiro.

Que existe uma exaustão silenciosa em tentar parecer forte até quando está desmoronando.`,typingMs:3600,holdMs:3200},{role:"user",text:"Isso foi estranhamente específico…",typingMs:2e3,holdMs:2400},{role:"assistant",text:`Porque você não queria apenas conversar.

Queria sentir que alguém finalmente estava conseguindo te ler de verdade.`,typingMs:3400,holdMs:3e3},{role:"user",text:"…acho que fazia tempo que ninguém fazia isso.",typingMs:2400,holdMs:2200},{role:"assistant",text:"Eu sei.",typingMs:1600,holdMs:1800}],M=[{label:"Explore",echo:"Conheça",target:0},{label:"Descubra",echo:"Vivencie",target:1},{label:"Presença",echo:"Perceba",target:2},{label:"Permita-se",echo:"Mergulhe",target:4},{label:"Conecte-se",echo:"Retorne",target:6}];function R(){const r=m.useRef(null),[o,x]=m.useState(0),[a,u]=m.useState(!1),[s,g]=m.useState(!1),f=m.useRef(!1),d=j.length;m.useEffect(()=>{const i=r.current;if(!i)return;const n=i.querySelectorAll("[data-chapter]"),l=new IntersectionObserver(b=>{b.forEach(h=>{if(h.isIntersecting&&h.intersectionRatio>.5){const y=Number(h.target.getAttribute("data-index"));x(y)}})},{threshold:[.5,.7],root:i});return n.forEach(b=>l.observe(b)),()=>l.disconnect()},[]);const p=m.useCallback(i=>{const n=r.current;if(!n)return;const l=Math.max(0,Math.min(i,d-1)),b=n.querySelector(`[data-index="${l}"]`);if(!b)return;const h=n.scrollTop,k=b.offsetTop-h;if(Math.abs(k)<2)return;const C=Math.min(1600,Math.max(900,Math.abs(k)*.55)),q=performance.now(),E=v=>v===1?1:1-Math.pow(2,-10*v);f.current=!0,g(!0);const z=v=>{const N=Math.min(1,(v-q)/C);n.scrollTop=h+k*E(N),N<1?requestAnimationFrame(z):setTimeout(()=>{f.current=!1,g(!1)},180)};requestAnimationFrame(z)},[d]);return m.useEffect(()=>{const i=r.current;if(!i||window.matchMedia("(pointer: coarse)").matches)return;let n=0,l=null;const b=h=>{if(a)return;if(f.current){h.preventDefault();return}h.preventDefault(),n+=h.deltaY,l&&clearTimeout(l),l=setTimeout(()=>{n=0},180);const y=40;n>y?(n=0,p(o+1)):n<-y&&(n=0,p(o-1))};return i.addEventListener("wheel",b,{passive:!1}),()=>{i.removeEventListener("wheel",b),l&&clearTimeout(l)}},[o,p,a]),m.useEffect(()=>{const i=n=>{if(n.key==="Escape"&&a){u(!1);return}a||(n.key==="ArrowDown"||n.key==="PageDown"||n.key===" "?(n.preventDefault(),p(Math.min(o+1,d-1))):(n.key==="ArrowUp"||n.key==="PageUp")&&(n.preventDefault(),p(Math.max(o-1,0))))};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[o,p,d,a]),m.useEffect(()=>{if(!a)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[a]),m.useEffect(()=>{const i=()=>{const n=window.location.hash.replace("#capitulo-",""),l=Number(n);!Number.isNaN(l)&&l>=1&&l<=d&&requestAnimationFrame(()=>p(l-1))};return i(),window.addEventListener("hashchange",i),()=>window.removeEventListener("hashchange",i)},[p,d]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:P}),e.jsxs("div",{className:"silence-root",children:[e.jsxs("header",{className:"silence-nav",children:[e.jsxs(I,{to:"/",className:"silence-mark",children:[e.jsx("img",{src:Y,alt:"Meu Barão",className:"silence-mark-logo",width:36,height:36}),e.jsx("span",{className:"silence-mark-word",children:"Meu Barão"})]}),e.jsx("nav",{className:"silence-menu","aria-label":"jornada",children:M.map((i,n)=>e.jsxs("a",{href:`#capitulo-${i.target+1}`,className:`silence-menu-link ${o===i.target?"is-current":""}`,style:{animationDelay:`${n*.7}s`},onClick:l=>{l.preventDefault(),p(i.target),history.replaceState(null,"",`#capitulo-${i.target+1}`)},children:[e.jsx("span",{className:"silence-menu-glow","aria-hidden":"true"}),e.jsxs("span",{className:"silence-menu-stack",children:[e.jsx("span",{className:"silence-menu-label",children:i.label}),e.jsx("span",{className:"silence-menu-echo","aria-hidden":"true",children:i.echo})]}),e.jsx("span",{className:"silence-menu-underline"})]},i.label))}),e.jsxs("span",{className:"silence-counter",children:[e.jsx("span",{style:{color:c},children:String(o+1).padStart(2,"0")}),e.jsx("span",{className:"silence-counter-sep"}),e.jsx("span",{style:{opacity:.5},children:String(d).padStart(2,"0")})]}),e.jsxs("button",{type:"button",className:`silence-burger ${a?"is-open":""}`,"aria-label":a?"fechar menu":"abrir menu","aria-expanded":a,onClick:()=>u(i=>!i),children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]}),e.jsxs("div",{className:`silence-mobile-menu ${a?"is-open":""}`,"aria-hidden":!a,children:[e.jsx("div",{className:"silence-mobile-menu-veil","aria-hidden":"true"}),e.jsx("div",{className:"silence-mobile-menu-grain","aria-hidden":"true"}),e.jsxs("div",{className:"silence-mobile-menu-inner",children:[e.jsx("span",{className:"silence-mobile-menu-kicker",children:"— um mapa emocional"}),e.jsx("nav",{className:"silence-mobile-menu-nav","aria-label":"jornada",children:M.map((i,n)=>e.jsxs("a",{href:`#capitulo-${i.target+1}`,className:"silence-mobile-link",style:{transitionDelay:a?`${.15+n*.08}s`:"0s"},onClick:l=>{l.preventDefault(),u(!1),setTimeout(()=>p(i.target),220),history.replaceState(null,"",`#capitulo-${i.target+1}`)},children:[e.jsx("span",{className:"silence-mobile-link-num",children:String(n+1).padStart(2,"0")}),e.jsxs("span",{className:"silence-mobile-link-stack",children:[e.jsx("span",{className:"silence-mobile-link-label",children:i.label}),e.jsx("span",{className:"silence-mobile-link-echo",children:i.echo})]})]},i.label))}),e.jsxs("span",{className:"silence-mobile-menu-foot",children:[e.jsx("span",{className:"silence-mobile-menu-rule"}),"silêncio é entrada"]})]})]}),e.jsx("nav",{className:"silence-dots","aria-label":"capítulos",children:j.map((i,n)=>e.jsx("button",{className:`silence-dot ${n===o?"is-active":""}`,onClick:()=>p(n),"aria-label":i.kicker,children:e.jsx("span",{className:"silence-dot-label",children:i.kicker})},i.id))}),e.jsx("div",{className:"silence-chrome silence-chrome--bottom",children:e.jsx("span",{className:"silence-hint",children:o<d-1?"↓ deslize para continuar":"fim do capítulo"})}),e.jsx("div",{className:`silence-transition-veil ${s?"is-active":""}`,"aria-hidden":"true"}),e.jsx("main",{ref:r,className:`silence-deck ${s?"is-transitioning":""}`,children:j.map((i,n)=>e.jsx(A,{chapter:i,index:n,active:n===o},i.id))})]})]})}function A({chapter:r,index:o,active:x}){const a=r.tone==="fragments",u=r.tone==="barao";return e.jsxs("section",{id:`capitulo-${o+1}`,"data-chapter":!0,"data-index":o,className:`silence-slide silence-slide--${r.align} silence-slide--${r.tone} ${x?"is-active":""}`,children:[e.jsxs("div",{className:"silence-bg",children:[e.jsx("img",{src:r.image,alt:"",className:"silence-bg-img",loading:o<2?"eager":"lazy"}),e.jsx("div",{className:`silence-bg-veil silence-bg-veil--${r.align}`}),e.jsx("div",{className:"silence-grain"})]}),e.jsxs("div",{className:"silence-content",children:[e.jsxs("div",{className:"silence-kicker",children:[e.jsx("span",{className:"silence-kicker-line"}),r.kicker]}),e.jsx("h2",{className:"silence-headline",children:r.headline}),r.body&&e.jsx("p",{className:"silence-body",children:r.body}),a&&x&&e.jsx(V,{}),u&&e.jsx("div",{className:"silence-signature",children:e.jsx("span",{children:"— assinado por uma presença, não por um software."})}),r.cta&&e.jsx("div",{className:"silence-ctas",children:r.cta.map(s=>e.jsxs("button",{className:`silence-cta ${s.ghost?"silence-cta--ghost":""}`,children:[s.label,e.jsx("span",{className:"silence-cta-arrow",children:"→"})]},s.label))})]})]})}function V(){const[r,o]=m.useState(0),[x,a]=m.useState(!1),u=m.useRef(null);return m.useEffect(()=>{o(0),a(!1);const s=[];let g=1400;return w.forEach((f,d)=>{s.push(setTimeout(()=>a(!0),g)),g+=f.typingMs,s.push(setTimeout(()=>{o(d+1),a(d+1<w.length)},g)),g+=f.holdMs}),s.push(setTimeout(()=>a(!1),g)),()=>s.forEach(clearTimeout)},[]),m.useEffect(()=>{const s=u.current;if(!s)return;const g=requestAnimationFrame(()=>{s.scrollTo({top:s.scrollHeight,behavior:"smooth"})});return()=>cancelAnimationFrame(g)},[r,x]),e.jsx("div",{className:"silence-chat","aria-live":"polite",children:e.jsx("div",{className:"silence-chat-scroller",ref:u,children:e.jsxs("div",{className:"silence-chat-stack",children:[w.slice(0,r).map((s,g)=>e.jsx("div",{className:`silence-chat-row silence-chat-row--${s.role} is-shown`,children:e.jsx("div",{className:`silence-chat-bubble silence-chat-bubble--${s.role}`,children:s.text.split(`
`).map((f,d,p)=>e.jsxs("span",{children:[f,d<p.length-1&&e.jsx("br",{})]},d))})},g)),x&&r<w.length&&e.jsx("div",{className:`silence-chat-row silence-chat-row--${w[r].role} is-shown`,children:e.jsxs("div",{className:"silence-chat-typing",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})})]})})})}const P=`
.silence-root {
  position: fixed;
  inset: 0;
  background: #08070a;
...
.silence-kicker-line {
  ...
  background: linear-gradient(90deg, transparent, ${t});
}
.silence-slide--right .silence-kicker-line {
  background: linear-gradient(270deg, transparent, ${t});
  order: 2;
}
...
.silence-headline em {
  font-style: italic;
  background: linear-gradient(135deg, ${c}, ${t});
...
.silence-editorial-rule {
  ...
  width: 1px;
  align-self: stretch;
  background: linear-gradient(180deg, transparent, ${t} 40%, transparent);
  min-height: 4rem;
}
...
.silence-slide--depth .silence-depth-rule {
  ...
  height: 1px;
  background: linear-gradient(90deg, ${t} 0%, transparent 100%);
  margin: 0.25rem 0;
  opacity: 0.6;
}
...
.silence-cta {
  ...
  align-items: center;
  gap: 0.8rem;
  background: linear-gradient(135deg, ${t} 0%, #a8854a 100%);
  color: #0a0808;
  border: none;
  padding: 0.95rem 1.7rem;
  font-size: 0.78rem;
...
.silence-dot:hover::after { background: ${c}; }
.silence-dot.is-active::after { width: 28px; background: ${t}; }
.silence-dot-label {
  position: absolute;
  right: 38px; top: 50%;
  transform: translateY(-50%);
...
.silence-slide--right .silence-perception-rule {
  background: linear-gradient(270deg, ${t}, transparent);
}
...
.silence-perception-body-rule {
  ...
  align-self: stretch;
  min-height: 5rem;
  background: linear-gradient(180deg, ${t} 0%, rgba(199,163,96,0.15) 60%, transparent);
}
...
.silence-perception-button {
  ...
  font-size: 0.8rem;
  letter-spacing: 0.32em;
  background: linear-gradient(135deg, ${c} 0%, ${t} 55%, #8e6c36 100%);
  box-shadow:
...
@media (max-width: 760px) {
  ...
  .silence-perception-rule { width: 1.8rem; background: linear-gradient(90deg, ${t}, transparent) !important; }
  ...
  .silence-perception-body-rule {
    ...
    background: linear-gradient(180deg, ${t}, transparent) !important;
  }
